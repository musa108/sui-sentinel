 ...
 */
export function buildPrompt(tx: TransactionData): string {
 ...
 */
export async function analyzeTransaction(tx: TransactionData): Promise<AIAnalysisResult> {
...
function runHeuristicAI(tx: TransactionData): AIAnalysisResult {
  let score = 10;
