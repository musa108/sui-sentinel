...
class BlockchainListener {
    ...
    suiClient = null;
    constructor() {
        const rpcUrl = process.env.SUI_RPC_URL || (0, client_1.getFullnodeUrl)('testnet');
        try {
    ...
    async runSimulationLoop() {
        ...
        while (this.isRunning) {
            try {
                ...
                const alert = await (0, riskEngine_js_1.processTransaction)(rawTx);
...
exports.blockchainListener = new BlockchainListener();
